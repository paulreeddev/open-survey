<template>
  <div class="h-screen w-screen bg-[#0747A6]">
      ...
      <div>
        <div class="flex justify-center items-center">
          ...
          <!-- <div class="text-white px-5">
            <span class="text-4xl font-semibold"> IWKET </span><br />
            <span class="text">Care Studio</span>
          </div> -->
        </div>
        <div class="bg-white w-96 shadow-lg">
          <div class="flex">
            <div
              class="p-4 px-8 cursor-pointer"
              :class="{
                'border-b-2 border-[#0747A6] text-[#0747A6]':
                  selectedTab == 'login',
              }"
          ...
          <div class="flex justify-center pt-5" v-if="selectedTab == 'login'">
          ...
          >
            Please provide valid credentials to register.
          </div>
          <v-alert
            dense
            outlined
          ...
          <div class="py-3 px-7" v-if="selectedTab == 'login'">
          ...
          <div class="px-5">
            <div>This is made possible by:</div>
            <div class="flex justify-around">
              <img
                ...
                class="mr-3"
              />
              <svg width="688" height="118" viewBox="0 0 688 118" fill="none">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      } else if (this.selectedTab == "register") {
    ...
    getErrorMessage(name) {
      if (this.errors) {
        if (this.errors.email && name == "email") {
          return this.errors.email;
        } else if (this.errors.password && name == "password") {
          return this.errors.password[0];
        } else if (this.errors.name && name == "name") {
          return this.errors.name[0];
        } else if (
          this.errors.password_confirmation &&
          name == "password_confirmation"
        ) {
          return this.errors.password_confirmation[0];
        } else {
          return "";
        }
      }
